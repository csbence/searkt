            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.goals = new java.util.ArrayList<Location>(_list24.size);
                Location _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new Location();
                  _elem25.read(iprot);
                  struct.goals.add(_elem25);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.blockedCells = new java.util.HashSet<Location>(2*_set27.size);
                Location _elem28;
                for (int _i29 = 0; _i29 < _set27.size; ++_i29)
                {
                  _elem28 = new Location();
                  _elem28.read(iprot);
                  struct.blockedCells.add(_elem28);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Init struct) throws org.apache.thrift.TException {
      ...
      if (struct.goals != null) {
        oprot.writeFieldBegin(GOALS_FIELD_DESC);
        {
          ...
          for (Location _iter30 : struct.goals)
          {
            _iter30.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.blockedCells != null) {
        oprot.writeFieldBegin(BLOCKED_CELLS_FIELD_DESC);
        {
          ...
          for (Location _iter31 : struct.blockedCells)
          {
            _iter31.write(oprot);
          }
          oprot.writeSetEnd();
  ...
  private static class InitTupleScheme extends org.apache.thrift.scheme.TupleScheme<Init> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, Init struct) throws org.apache.thrift.TException {
      ...
      struct.start.write(oprot);
      {
        ...
        for (Location _iter32 : struct.goals)
        {
          _iter32.write(oprot);
        }
      }
      {
        ...
        for (Location _iter33 : struct.blockedCells)
        {
          _iter33.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Init struct) throws org.apache.thrift.TException {
      ...
      struct.setStartIsSet(true);
      {
        ...
        struct.goals = new java.util.ArrayList<Location>(_list34.size);
        Location _elem35;
        for (int _i36 = 0; _i36 < _list34.size; ++_i36)
        {
          _elem35 = new Location();
          _elem35.read(iprot);
          struct.goals.add(_elem35);
        }
      }
      struct.setGoalsIsSet(true);
      {
        ...
        struct.blockedCells = new java.util.HashSet<Location>(2*_set37.size);
        Location _elem38;
        for (int _i39 = 0; _i39 < _set37.size; ++_i39)
        {
          _elem38 = new Location();
          _elem38.read(iprot);
          struct.blockedCells.add(_elem38);
        }
      }
      struct.setBlockedCellsIsSet(true);
    }
