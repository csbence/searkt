            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.goals = new java.util.ArrayList<Location>(_list32.size);
                Location _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new Location();
                  _elem33.read(iprot);
                  struct.goals.add(_elem33);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.blockedCells = new java.util.HashSet<Location>(2*_set35.size);
                Location _elem36;
                for (int _i37 = 0; _i37 < _set35.size; ++_i37)
                {
                  _elem36 = new Location();
                  _elem36.read(iprot);
                  struct.blockedCells.add(_elem36);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Init struct) throws org.apache.thrift.TException {
      ...
      if (struct.goals != null) {
        oprot.writeFieldBegin(GOALS_FIELD_DESC);
        {
          ...
          for (Location _iter38 : struct.goals)
          {
            _iter38.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.blockedCells != null) {
        oprot.writeFieldBegin(BLOCKED_CELLS_FIELD_DESC);
        {
          ...
          for (Location _iter39 : struct.blockedCells)
          {
            _iter39.write(oprot);
          }
          oprot.writeSetEnd();
  ...
  private static class InitTupleScheme extends org.apache.thrift.scheme.TupleScheme<Init> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, Init struct) throws org.apache.thrift.TException {
      ...
      struct.start.write(oprot);
      {
        ...
        for (Location _iter40 : struct.goals)
        {
          _iter40.write(oprot);
        }
      }
      {
        ...
        for (Location _iter41 : struct.blockedCells)
        {
          _iter41.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Init struct) throws org.apache.thrift.TException {
      ...
      struct.setStartIsSet(true);
      {
        ...
        struct.goals = new java.util.ArrayList<Location>(_list42.size);
        Location _elem43;
        for (int _i44 = 0; _i44 < _list42.size; ++_i44)
        {
          _elem43 = new Location();
          _elem43.read(iprot);
          struct.goals.add(_elem43);
        }
      }
      struct.setGoalsIsSet(true);
      {
        ...
        struct.blockedCells = new java.util.HashSet<Location>(2*_set45.size);
        Location _elem46;
        for (int _i47 = 0; _i47 < _set45.size; ++_i47)
        {
          _elem46 = new Location();
          _elem46.read(iprot);
          struct.blockedCells.add(_elem46);
        }
      }
      struct.setBlockedCellsIsSet(true);
    }
