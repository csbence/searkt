 ...
 */
class PointRobotLOSTEnvironment(private val domain: PointRobotLOST, private val initialState: PointRobotLOSTState) : Environment<PointRobotLOSTState> {

    private val logger = LoggerFactory.getLogger(PointRobotLOSTEnvironment::class.java)
