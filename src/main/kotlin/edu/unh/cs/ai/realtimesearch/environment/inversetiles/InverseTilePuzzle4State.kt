 ...
 *
 */
data class InverseTilePuzzle4State(val zeroIndex: Int, var tiles: ByteArray, val heuristic: Double) : State<InverseTilePuzzle4State> {



    override fun copy(): InverseTilePuzzle4State = InverseTilePuzzle4State(zeroIndex, ByteArray(16, {tiles[it]}), heuristic)
