...
public class ExplicitEstimationSearchHFixC<StateType extends State<StateType>> extends ClassicalPlanner<StateType> {
    ...
    public ExplicitEstimationSearchHFixC(Domain<StateType> domain, ExperimentConfiguration configuration) {
    ...
    public ExplicitEstimationSearchHFixC(double weight) {
        this.weight = weight;
    }
