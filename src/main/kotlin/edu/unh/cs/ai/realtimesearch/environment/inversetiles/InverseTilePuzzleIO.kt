...
object InverseTilePuzzleIO {
    ...
    fun parseFromStream(input: InputStream, actionDuration: Long): SlidingTilePuzzleInstance {
        ...
        val slidingTilePuzzle = InverseTilePuzzle(dimension, actionDuration)
        val tiles = ByteArray(16, {0.toByte()})
        val slidingTilePuzzleState = InverseTilePuzzle4State(0, tiles, 0.0, 0.0)
        ...
        try {
            ...
            return SlidingTilePuzzleInstance(slidingTilePuzzle, InverseTilePuzzle4State(zeroIndex, slidingTilePuzzleState.tiles, heuristic, distance))
        } catch (e: NumberFormatException) {
...
data class SlidingTilePuzzleInstance(val domain: InverseTilePuzzle, val initialState: InverseTilePuzzle4State)