...
object InverseTilePuzzleIO {
    ...
    fun parseFromStream(input: InputStream, actionDuration: Long): SlidingTilePuzzleInstance {
        ...
        val slidingTilePuzzleState = InverseTilePuzzle4State(0, tiles, 0.0)
        ...
        try {
            ...
            return SlidingTilePuzzleInstance(slidingTilePuzzle, InverseTilePuzzle4State(zeroIndex, slidingTilePuzzleState.tiles, heuristic))
        } catch (e: NumberFormatException) {
