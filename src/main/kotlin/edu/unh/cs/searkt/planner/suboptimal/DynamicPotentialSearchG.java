...
import edu.unh.cs.searkt.util.collections.ghheap.GH_heap;
 ...
 */
public class DynamicPotentialSearchG<StateType extends State<StateType>> extends OfflinePlanner<StateType> {
