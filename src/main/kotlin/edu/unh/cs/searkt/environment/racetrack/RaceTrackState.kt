 ...
 */
data class RaceTrackState(val x: Int, val y: Int, val dX: Int, val dY: Int, val isCollision: Boolean = false) : State<RaceTrackState> {

    // isCollision not included in equals
    ...
    // isCollision not included in hash code
