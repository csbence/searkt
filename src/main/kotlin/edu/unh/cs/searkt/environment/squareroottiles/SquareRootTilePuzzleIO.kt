package edu.unh.cs.searkt.environment.squareroottiles

import edu.unh.cs.searkt.environment.location.Location
import java.io.InputStream
import java.util.*

object SquareRootTilePuzzleIO {
    ...
    fun parseFromStream(input: InputStream, actionDuration: Long): SlidingTilePuzzleInstance {
        ...
        val slidingTilePuzzle = SquareRootTilePuzzle(dimension, actionDuration)
        val tiles = ByteArray(16, { 0.toByte() })
        val slidingTilePuzzleState = SquareRootTiles4State(0, tiles, 0.0, 0.0)
        ...
        try {
            ...
            return SlidingTilePuzzleInstance(slidingTilePuzzle, SquareRootTiles4State(zeroIndex, slidingTilePuzzleState.tiles, heuristic, distance))
        } catch (e: NumberFormatException) {
...
data class SlidingTilePuzzleInstance(val domain: SquareRootTilePuzzle, val initialState: SquareRootTiles4State)