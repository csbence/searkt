...
class VacuumWorldTest {
    ...
    fun testGoalChecker() {
        ...
        val goalState1 = VacuumWorldState(l1, emptySet())
        val goalState2 = VacuumWorldState(l2, emptySet())
        val notGoalState1 = VacuumWorldState(l2, setOf(l1))
        val notGoalState2 = VacuumWorldState(l2, setOf(l1, l2))
