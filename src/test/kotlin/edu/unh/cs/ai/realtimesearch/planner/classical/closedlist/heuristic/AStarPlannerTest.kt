...
//    }
    ...
    fun testAStar1() {
        ...
        kotlin.test.assertTrue { aStarAgent.plan(initialState, StaticExpansionTerminationChecker(10000L)).isEmpty() }
    }
    ...
    fun testAStar2() {
        ...
        val initialState = slidingTilePuzzle.initialState
        val aStarAgent = AStarPlanner(slidingTilePuzzle.domain)
        val plan = aStarAgent.plan(initialState, StaticExpansionTerminationChecker(10000L))
        println(plan)
    ...
    fun testAStar4() {
        ...
        val initialState = slidingTilePuzzle.initialState
        val aStarAgent = AStarPlanner(slidingTilePuzzle.domain)
        val plan = aStarAgent.plan(initialState, StaticExpansionTerminationChecker(100000L))
        println(plan)
        kotlin.test.assertTrue { plan.isNotEmpty() }
